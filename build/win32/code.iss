...
AppPublisher=Nexgile
AppPublisherURL=https://nexgile.com/
AppSupportURL=https://nexgile.com/support
AppUpdatesURL=https://nexgile.com/download
DefaultGroupName={#NameLong}
AllowNoIcons=yes
OutputDir={#OutputDir}
OutputBaseFilename=NexgileCodeSetup
Compression=lzma
